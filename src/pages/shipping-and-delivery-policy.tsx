  ...
  return (
    <body className="container">
      <div className="policies-container">
        <h1 className="policy-heading">Shipping & Delivery Policy</h1>
        ...
        <p className="policy-content">
          G PAVAN KUMAR is not liable for any delay in delivery by the courier
          ...
          Days days from the date of the order and payment or as per the
          ...
          our helpdesk on or firely.india@gmail.com.
        </p>
