    ...
    <body className="container">
      <div className="policies-container">
        ...
        <p className="policy-content">
          G PAVAN KUMAR believes in helping its customers as far as possible,
        ...
        <p className="policy-content">
          G PAVAN KUMAR does not accept cancellation requests for perishable
        ...
        <p className="policy-content">
          ...
          his own end. This should be reported within 2 Days days of receipt of
          ...
          the notice of our customer service within 2 Days days of receiving the
        ...
        <p className="policy-content">
          ...
          Refunds approved by the G PAVAN KUMAR, it’ll take 3-5 Days days for
